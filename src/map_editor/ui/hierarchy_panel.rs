...
pub struct HierarchyQuery<'w, 's> {
    ...
    event_objects: Query<
        'w,
        's,
        (Entity, &'static EventObject, Option<&'static Name>),
        With<EditorSelectable>,
    >,
    /// Warp objects  
    warp_objects:
        Query<'w, 's, (Entity, &'static WarpObject, Option<&'static Name>), With<EditorSelectable>>,
}
    ...
    egui::SidePanel::left("hierarchy_panel")
        ...
        .show(ctx, |ui| {
            ...
            let selected_set: std::collections::HashSet<Entity> =
                map_editor_state.selected_entities.iter().copied().collect();
            ...
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                for category in category_order {
                    if let Some(objects) = categories.get(&category) {
                        ...
                        ui.collapsing(
                            format!("{} ({})", category.display_name(), objects.len()),
                            |ui| {
